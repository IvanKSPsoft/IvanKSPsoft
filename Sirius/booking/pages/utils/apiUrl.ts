export const URLS = {
    visaUrl : 'https://siq.azure-api.net/test/mle-documents/api/mle-upload/v2/VISA/VISA_TRAVEL/trips',
    bookingUrl: 'https://clx-scus-test-trustassure-booking.azurewebsites.net',
